...
; NOTE: Moved to Widget Controller
...
;   ============================== /;
;   frenzy = FrenzyStacks.GetValue()
;   ; Debug.Trace("NIGHTMARE NIGHT - Blood Frenzy Effect Start - frenzy = " + frenzy)
;   If(frenzy > 9)
;     Widget.CreateFrenzyInstance(GetDuration(), 10)
;     return
;   EndIf
;   Widget.CreateFrenzyInstance(GetDuration(), frenzy)
